...
In this project, I started practicing Python file handling. I used  JSON module's built-in `with`, `open`, and `read` functions to read and write files as well as serialize and deserialize JSON objects.
