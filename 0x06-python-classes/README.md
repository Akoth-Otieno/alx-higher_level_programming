...
THis project is an introduction to object-oriented programming (OOP). I begin getting familiar with and practicing OOP using classes and objects in Python.  I learned about attributes, methods, and
