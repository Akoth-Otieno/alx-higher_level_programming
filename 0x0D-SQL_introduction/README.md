# SQL - Introduction
In this project, I began to work with databses, sepcifically the realtional database known as SQL. 
I started by practicing introductory data definition and data manipulation language, as well as creating subqueries and functions.
