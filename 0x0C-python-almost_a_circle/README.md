...
I summed up Python object-oriented programming skills in this project by coding three connected classes to represent rectangles and squares. To test all functionality for each class, I created my own test suite using the `unittest` module.
