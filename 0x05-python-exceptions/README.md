# Python - Exceptions
In this project, I learn how to handle errors and exceptions in Python.

The main objectives of the projectwas to gain insights into:
...
* when to implement a clean-up actiion after an  exception.
