...
This project introduces the conditional statements and loops in Python.
 
I began using `if`,`if ... else`, `break`, `continue`, `pass`, and `range` statements with `while` and `for` loops. 

The practice took the form of writing my own Python functions while getting familiar with variables, tracebacks, and arithmetic operators.

## Function Prototypes 
Prototypes of the functions contained in the lists.h file of this project.
